...
Welcome to the course page for **Statistical Learning II**. This is an **old webpage** for the Fall 2025 iteration of the course. Visit [this page](/teaching/iaso) the most recent iteration with the course material. 
...
For the course material, refer to the most recent iteration of the course.

| Date        | Lecture Topic                | Materials                            |
|-------------|------------------------------|--------------------------------------|
| Sept 10     | - Recap of maths        |  Slides |
| Sept 17    | - Introduction <br> - Supervised Learning     | Slides |
...
| Nov 12     | - Bias-variance decomposition (continued)  <br> - Ridge regression| Slides |
| Nov 19     | Best subset selection | Slides |
| Nov 26     | No class (3h TD)| |
| Dec 03     | - LASSO  <br> - Feature maps | Slides |
